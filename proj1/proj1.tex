...
\usepackage[a4paper, left=1.8cm, top=1.8cm, text={18cm, 25cm}]{geometry}
\usepackage{csquotes}
...
\begin{document}
  ...
  \begin{quotation}
    Čím více \emph{druhů}, \textbf{řezů}, {\tiny velikostí}, {\color{red} barev} písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\Large \fontfamily{pzc}\selectfont dokument} vypadat.
  ...
  V~{\LaTeX}u ji sázíme raději příkazem \texttt{\char`\\emph\string{text\string}} než \texttt{\char`\\textit\string{text\string}}.
  ...
  \begin{itemize}
    ...
    (Šetřete i s~textem v~závorkách.)\footnotetext{Příliš mnoho poznámek pod čarou čtenáře zbytečně rozptyluje.}
  ...
  V~češtině se používají uvozovky typu \uv{9966} místo anglických ‘‘uvozovek” nebo dvojitých \textquotedbl{}uvozovek\textquotedbl{}.
  ...
  Pro systematické do\-plnění vlnek slouží volně šiřitelný program vlna od pana Olšáka\footnotemark{}.\footnotetext{Viz \url{http://petr.olsak.net/ftp/olsak/vlna/}}
